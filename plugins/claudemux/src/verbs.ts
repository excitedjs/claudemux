...
export const TM_VERBS: readonly VerbSpec[] = [
  ...
  { name: 'wait', summary: "Wait for a teammate's next turn and print the reply.", registry: 'none' },
  ...
  { name: 'kill', summary: "Stop a teammate's broker and its claude child.", registry: 'remove' },
  { name: 'reload', summary: 'Fan out /reload-plugins to one or more teammates.', registry: 'none' },
  { name: 'ls', summary: 'List running teammates.', registry: 'none' },
  ...
  { name: 'history', summary: 'Query teammate session history as bounded JSON.', registry: 'none' },
  { name: 'mem', summary: "Print a sibling repo's auto-memory index.", registry: 'none' },
  { name: 'status', summary: "Broker snapshot of a teammate (diagnostic).", registry: 'none' },
  { name: 'poll', summary: "Block until a teammate's latest reply matches a regex (diagnostic).", registry: 'none' },
  { name: 'doctor', summary: 'Self-check: tm path/version, env, claude binary, active teammates.', registry: 'none' },
